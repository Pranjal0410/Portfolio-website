...
function Guestbook({onBack}:{onBack:()=>void}) {
  ...
  return(<div className="min-h-screen bg-[#0b0b16] text-white relative" style={{fontFamily:'var(--font-heading)'}}><EnvLayer/><AtmoLayer/><div className="noise-overlay"/>
    ...
    <div className="relative z-10 max-w-3xl mx-auto px-4 pt-32 pb-20"><div className="text-center mb-12"><span className="text-sm font-bold text-[var(--accent)] uppercase tracking-[0.2em]">The Community Wall</span><h1 className="mt-4 text-5xl sm:text-6xl md:text-7xl font-extrabold tracking-tighter leading-[1]">Leave Your <span className="shimmer-text">Mark</span></h1><p className="mt-5 text-lg text-zinc-500 font-light">Share your thoughts, feedback, or just say hi!</p></div>
